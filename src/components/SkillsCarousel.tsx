...
export default function SkillsCarousel() {
  return (
    <motion.div
      ...
      className="w-full max-w-3xl md:max-w-4xl lg:max-w-5xl mx-auto overflow-hidden py-2 md:py-4 mt-2 md:mt-6 relative mask-[linear-gradient(to_right,transparent,black_10%,black_90%,transparent)]"
    >
      <motion.div
